...
**📌DEPLOY ON HEROKU**
   - ***Click [`FORK`](https://github.com/Giftedmaurice/Flash/fork) and `Star ⭐ Repository` for Courage.***
   ...
   - ***Now [DEPLOY](https://dashboard.heroku.com/new?template=https://github.com/Giftedmaurice/Flash).***
